			...
			<div className="px-16">
				<div className="flex flex-col">
					<div className="justify-center">
						...
						<div className="font-changa font-light text-2.25xl mt-4 leading-none text-center text-white">
							RegretsReporter
						</div>
					</div>
				</div>
								...
								<div className="flex flex-col text-center text-white">
									...
									<div className="font-sans font-light text-left text-xl mt-5 leading-tight">
										<p>
											...
											Mozilla’s crowdsourced research into YouTube’s algorithm to learn more about what people regret
											being recommended and how the algorithm responds to user feedback.
										</p>
										<br />
										<p>
											If you choose to participate in our research, you may be assigned to a “control” (or “placebo”)
											group and the <span className="font-bold">extension may not function</span>. See more information
											about our research{' '}
											<a href={experimentGroupsUrl} target="_blank" className="underline" rel="noreferrer">
												here
											</a>
											. If you do choose to participate, please leave the extension installed even if it does not appear
											to be doing anything.
										</p>
										<br />
										<p>
											Please also be aware that if you participate in our research, the extension will send Mozilla
											information about the number of videos you view, your use of features to control your
											recommendations, and information about the videos that you are recommended. To learn more about
											what RegretsReporter will collect, read our{' '}
...
*/}
						...
						<div className="flex flex-col text-center mt-22.5">
							<div className="font-changa text-huge slides-header">Submitting feedback and a YouTube Regret</div>
							<div className="font-sans text-2xl mt-3.25 mb-8.75 slides-subheader">
